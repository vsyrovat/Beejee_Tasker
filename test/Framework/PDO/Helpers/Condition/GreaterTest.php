...
class GreaterTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $condition = new Greater('table.foo', 'bar');
    ...
    {
        $condition = new Greater('table.foo', 'bar', null, 'baz');
        ...
        $condition = new Greater('table.foo', 'bar', null, null);
        self::assertEquals('(`table`.`foo`>:table_foo)', $condition->getSQL());
        self::assertEquals('bar', $condition->getValue());
        self::assertEquals(['table_foo' => 'bar'], $condition->getParams());
